...
public class ProjectVersionService {
	...
	public ProjectVersionService(ProjectVersionDao projectVersionDao) {
	...
	public List<ProjectVersion> getAllProjectVersionsWithAllVersions(Project project){
		List<ProjectVersion> projectVersions = this.getAllProjectVersions(project);
