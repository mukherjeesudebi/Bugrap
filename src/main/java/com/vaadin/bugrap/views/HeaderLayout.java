    ...
    public void createHeader() {
        ...
        projectSelect.addValueChangeListener(event -> {
            ...
            this.reportDetailsLayout.getReportprojectVersionSelect()
                    .setItems(this.projectVersionService
                            .getAllProjectVersions(event.getValue()));
        ...
        userName.setText(authenticatedUserImpl.get().get().getName());
        ...
        // headerHorizontalLayout.getStyle().set("box-shadow", "0 4px 7px -2px
        // gray");
